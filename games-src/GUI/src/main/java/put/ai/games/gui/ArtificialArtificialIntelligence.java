    ...
    public Move nextMove(Board board) {
        try {
            ...
            for (; ; ) {
                ...
                // ordering is important - moves requiring more clicks for match must be considered first
                // moves requiring 3 clicks
                for (Move m : moves) {
