...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void announceWinner(Player.Color winner, String[] names) {
        String text;
        if (winner == null) {
            ...
            text = String.format("Wygrał %s (%s)", getColorName(winner), names[index]);
        }
    ...
    private void runGameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runGameActionPerformed
        ...
        try {
            ...
            new SwingWorker<Player.Color, Object>() {
                ...
                private Player.Color winner;
                private String[] names = g.getNames();
                ...
                protected void done() {
                    ...
                    announceWinner(this.winner, this.names);
                }
            }.execute();
        } catch (Exception ex) {
